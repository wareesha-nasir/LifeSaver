    ...
    <br><br><br>
            ...
            <div class="row">
                <div class="col-md-6" style="text-align: center;" >
                    ...
                    <div class="col-md-6 col-sm-12" style="text-align: justify; font-family: 'Roboto',sans-serif; " >
                        ...
                        <p style="margin-right: 5%; font-size:1.2rem; color: white;  background-image:linear-gradient(315deg, #eb6a6a 10%, #ca1028 74%); padding: 5%;">We have designed an obstacle avoider smart car, using 
                            Arduino UNO, ultrasonic sensor and servo motor, we have 
                            also used L298 motor driver. Our smart car will detect the 
                            obstacle in its path using the ultrasonic sensor and then it 
                            will change its path in order to avoid that obstacle. This 
                            smart car has many applications smart parking systems, 
                            smart vacuum cleaners etc.
                            </p> 
                        </div>
            </div>
            <br><br><br>
            <div class="row">
                    <div class="col-md-6 col-sm-12" style="text-align: justify; " >
                        ...
                        <p style="margin-left: 5%; font-size:1.2rem; font-family: 'Roboto',sans-serif; color: white; background-image: linear-gradient(315deg, #eb6a6a 10%, #ca1028 74%); padding: 5%;" > We have designed an obstacle avoider smart car, using 
                            Arduino UNO, ultrasonic sensor and servo motor, we have 
                            also used L298 motor driver. Our smart car will detect the 
                            obstacle in its path using the ultrasonic sensor and then it 
                            will change its path in order to avoid that obstacle. This 
